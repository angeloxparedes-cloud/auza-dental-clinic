...
$routes = [
    ...
    'admin_staff'           => ['AdminController',     'staff'],
    'admin_add_staff'       => ['AdminController',     'addStaff'],
    'admin_staff_status'    => ['AdminController',     'updateStaffStatus'],
    'admin_delete_staff'    => ['AdminController',     'deleteStaff'],
